{ inputs, self, ... }: {
  flake.homeModules.nvf = { pkgs, ... }: {
    home.packages = [
      self.packages.${pkgs.system}.myCustomNeovim
    ];
  };
  ...
  perSystem =
    ...
    #  configNvf = {
    #    options = { };
    #    config = import ./nvf.nix { inherit pkgs; };
    #  };
    #in
    {
      packages.myCustomNeovim =
              ...
              config = {
                vim = {
                  ...
                  languages = {
                    ...
                    bash.enable = true;
                    clang.enable = false; # TEMP because build fails
                    css.enable = true;
                    html.enable = true;
                    sql.enable = false;
                    java.enable = true;
                  ...
                  minimap = {
                    codewindow.enable = false; # TEMP errors when nvim launched with this enabled
                  };
                  ...
                  notes = {
                    orgmode.enable = false; # TEMP errors when this is enabled
