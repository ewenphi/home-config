      ...
      programs.vscodium = {
        ...
        profiles.default = {
          extensions = [
            ...
            #editorconfig
            inputs.nix-vscode-extensions.extensions.${pkgs.stdenv.hostPlatform.system}.open-vsx.editorconfig.editorconfig

            #lazygit
            inputs.nix-vscode-extensions.extensions.${pkgs.stdenv.hostPlatform.system}.open-vsx.chaitanyashahare.lazygit

            #conventional-commits
            inputs.nix-vscode-extensions.extensions.${pkgs.stdenv.hostPlatform.system}.open-vsx.vivaxy.vscode-conventional-commits
            ...
            #agents
            inputs.nix-vscode-extensions.extensions.${pkgs.stdenv.hostPlatform.system}.open-vsx.mistralai.mistral-vibe-code
            inputs.nix-vscode-extensions.extensions.${pkgs.stdenv.hostPlatform.system}.open-vsx.sst-dev.opencode
