---
name: five-whys-skills
description: This skill should be used when the user asks to "find the root cause", "why did this happen", "debug this issue", "analyze this bug", "what's causing this", "dig deeper", or needs to systematically trace a problem back to its fundamental cause rather than just addressing symptoms.
user-invocable: true
---
